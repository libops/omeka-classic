...
See the [Omeka Classic sitectl plugin docs](https://github.com/libops/sitectl-docs/blob/main/plugins/omeka-classic.mdx) for lifecycle operations, API helpers, resource shortcuts, and plugin maintenance.
